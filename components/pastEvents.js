    ...
    return (
      <section className="relative py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white text-center">Past Events</h2>
    ...
    <section className="relative py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-6xl font-bold mb-40 text-white text-center">
          <span className="inline-block border-b-2 border-purple-700 pb-2">Past Events</span>
        </h2>
              ...
              >
                ...
                <div className="w-full md:w-1/2 text-left">
                  <div className="p-6 bg-black/10 backdrop-blur-sm rounded-xl ">
                    {/* <span className="inline-block px-3 py-1 bg-purple-800 text-white text-sm rounded-full mb-4">Past Event</span> */}
